 ...
 *   描   述 :个人信息
 */
class RecommendAdapter constructor(context: Context) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
...
//    }
    ...
    override fun onCreateViewHolder(p0: ViewGroup, p1: Int): RecyclerView.ViewHolder {
        var itemView: View = LayoutInflater.from(context).inflate(R.layout.recommend_item, p0 , false)
